    ...
    const additionalDetail = user.hasWallet ? (
        <Fragment>
            ...
            <Paragraph type="secondary">
                ...
                <Text strong>any futher payments</Text>. This will prevent users from booking listing that you might have already created.
            </Paragraph>
        </Fragment>) : (
        <Fragment>
            <Paragraph>
                Interered in becoming a TinyHouse host? Register
                with your Stripe account!
            </Paragraph>
            <Button 
                type="primary" 
                className="user-profile__details-cta" onClick={redirectToStripe}>
                Connect with Stripe
            </Button>
            <Paragraph type="secondary">
                TinyHouse uses{" "}
                <a href="https://stripe.com/en-US/connect" 
                    target="_blank" 
